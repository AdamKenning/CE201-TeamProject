# User Stories MD (Concise version)
...
- ### User Story Structure
  ...
  - Explanation of Parts
    ...
    - I **want X**: Specifies the action or feature the user needs to use "X".
    - **So that Y**: Explains the purpose or value this feature provides "Y".
