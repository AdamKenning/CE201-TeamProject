...
SECRET_KEY = 'django-insecure-fnt(n35s4)px63^&frp!=^03%(&ec^g#*@_usd**0=yjp*m@iz'
...
# TODO for debugging, turned these off to allow easy passwords e.g. 1234. Turn back on before deployment
